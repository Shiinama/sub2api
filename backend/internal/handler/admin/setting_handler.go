...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		EnableClaudeCodeOAuthMimicry:           settings.EnableClaudeCodeOAuthMimicry,
...
type UpdateSettingsRequest struct {
	...
	EnableClaudeCodeOAuthMimicry           *bool   `json:"enable_claude_code_oauth_mimicry"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		EnableClaudeCodeOAuthMimicry: func() bool {
			if req.EnableClaudeCodeOAuthMimicry != nil {
				return *req.EnableClaudeCodeOAuthMimicry
			}
			return previousSettings.EnableClaudeCodeOAuthMimicry
		}(),
	...
	payload := dto.SystemSettings{
		...
		EnableClaudeCodeOAuthMimicry:           updatedSettings.EnableClaudeCodeOAuthMimicry,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.EnableClaudeCodeOAuthMimicry != after.EnableClaudeCodeOAuthMimicry {
		changed = append(changed, "enable_claude_code_oauth_mimicry")
	}
