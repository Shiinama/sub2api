...
const (
	...
	// SettingKeyEnableClaudeCodeOAuthMimicry 是否对非 Claude Code 客户端的 OAuth 请求启用 Claude Code 伪装（默认 true）
	SettingKeyEnableClaudeCodeOAuthMimicry = "enable_claude_code_oauth_mimicry"
