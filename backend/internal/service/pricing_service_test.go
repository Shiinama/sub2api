...
func TestParsePricingData_DerivesCatalogLongContextForNonGPTOrCodexModels(t *testing.T) {
	svc := &PricingService{}
	body := []byte(`{
...
func TestParsePricingData_DerivesClaudeAbove200KLongContext(t *testing.T) {
	svc := &PricingService{}
	body := []byte(`{
		"claude-sonnet-4-5": {
