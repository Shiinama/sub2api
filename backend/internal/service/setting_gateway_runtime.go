...
func (s *SettingService) getGatewayForwardingSettingsCached(ctx context.Context) gatewayForwardingSettingsResult {
	...
	val, _, _ := gatewayForwardingSF.Do("gateway_forwarding", func() (any, error) {
		...
		if err != nil {
			...
			return gatewayForwardingSettingsResult{openAITTFTMode: OpenAITTFTModeSemantic, fp: true, claudeCodeOAuthMimicry: true, claudeOAuthSystemPromptInjection: true, rewriteMessageCacheControl: s.defaultRewriteMessageCacheControl(), clientDatelineNormalization: true}, nil
		}
	...
	return gatewayForwardingSettingsResult{fp: true, claudeOAuthSystemPromptInjection: true, claudeCodeOAuthMimicry: true, clientDatelineNormalization: true}
}
