export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        claudeCodeOAuthMimicry: 'Claude Code OAuth Mimicry',
        claudeCodeOAuthMimicryHint: 'Default on: non-Claude-Code clients using Anthropic OAuth accounts are forwarded as Claude Code. Disabling maximizes client request passthrough, but Anthropic upstream may reject the request or use unexpected quota.',
