  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        claudeCodeOAuthMimicry: 'Claude Code OAuth 伪装',
        claudeCodeOAuthMimicryHint: '默认开启，非 Claude Code 客户端使用 Anthropic OAuth 账号时会模拟 Claude Code。关闭后最大化透传客户端请求，但可能被 Anthropic 上游拒绝或走非预期额度。',
